  ...
  return (
    <main>
      ...
      <div className='mt-5 flex flex-col items-center'>
        ...
        <p className='mb-5 text-center max-w-lg tracking-wide'>We pride ourselves on fostering a supportive and inclusive environment where everyone's contributions are valued and respected.</p>
      ...
      <h1 className="text-2xl text-center font-semibold mb-5 tracking-widest">Company Reviews</h1>
          <div className="max-w-screen-xl mx-auto bg-white overflow-hidden md:flex md:items-center md:justify-between">
              ...
              <div className="p-4 md:w-1/2">
                  ...
                  <p className="mt-2 text-gray-600 tracking-wide">Our user-friendly interface allows you to browse through categories effortlessly, making it simple to find what you're looking for. Filter your search results by price, brand, size, color, and more.</p>
      ...
      <div>
        <div className="max-w-screen-xl mx-auto bg-white overflow-hidden md:flex md:items-center md:justify-between">
          ...
          <div className="p-4 md:w-1/2">
            ...
            <p className="mt-2 text-gray-600 tracking-wide">Experience fast and reliable delivery straight to your doorstep. Whether you're shopping for yourself or sending a gift to a loved one, our efficient logistics network ensures timely delivery, so you can enjoy your purchases without delay.</p>
            <button className="mt-4 px-4 py-2 bg-fuchsia-800 text-white rounded hover:bg-fuchsia-700 focus:outline-none focus:bg-fuchsia-800">View</button>
          </div>
        </div>
      </div>
